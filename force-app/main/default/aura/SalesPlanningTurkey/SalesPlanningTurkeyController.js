({
       ...
       // console.log(currMonthValueFromMap)
        for(let key in Object.keys(lettMonthVsNumMonthMap)){
            if( key >= currMonthValueFromMap){
                //console.log("In SalesPLanningTurkeyComp-->C-->onActiveTabHandler_M-->key >= -->key-->"+key);
                //console.log('key >= -->numMonthVsLettMonthMap[key]-->'+numMonthVsLettMonthMap[key]);
                tabIdVsTrueOrFalse[numMonthVsLettMonthMap[key]] = false;
                //console.log("In SalesPLanningTurkeyComp-->C-->onActiveTabHandler_M-->key >= -->tabIdVsTrueOrFalse[numMonthVsLettMonthMap[key]]-->"+tabIdVsTrueOrFalse[numMonthVsLettMonthMap[key]]);
                ...
                //console.log("In SalesPLanningTurkeyComp-->C-->onActiveTabHandler_M-->Key-->"+key);
            } 
        }
    ...
    handleComponentEvent: function(component, event, helper) {
        console.log("In SalesPLanningTurkeyComp-->C-->handleComponentEvent_M-->Comp Event Received in Parent!!");
        var nextTab = event.getParam("nextTab");
        var currTab = event.getParam("currentTab");
        console.log("In SalesPLanningTurkeyComp-->C-->handleComponentEvent_M-->Comp Event Received in Parent VALUE-->Curr-->" + currTab);
        console.log("In SalesPLanningTurkeyComp-->C-->handleComponentEvent_M-->Comp Event Received in Parent VALUE-->Nxt-->" + nextTab);
    ...
    handleChange: function(component,event,helper) {
        //console.log("In SalesPLanningTurkeyComp-->C-->handleChange_M !!!");
        
        var selected = component.get("v.showTab");
        //console.log("In SalesPLanningTurkeyComp-->C-->handleChange_M-->-->TAbID-->" + selected);
        component.find("salesTab").set("v.selectedTabId", selected);
        
        //console.log("In SalesPLanningTurkeyComp-->C-->handleChange_M-->new/current value: " + event.getParam("value"));
        var oldTabId = event.getParam("oldValue");
        //console.log("In SalesPLanningTurkeyComp-->C-->handleChange_M-->old value: " + oldTabId);
    ...
    onActiveTabHandler : function(component,event,helper){
        //console.log("In SalesPLanningTurkeyComp-->C-->onActiveTabHandler_M Active Tab!!!");
    ...
    onTabBlur : function(component,event){
        //console.log("In SalesPLanningTurkeyComp-->C-->onTabBlur_M !!!");   
        //console.log("In SalesPLanningTurkeyComp-->C-->onTabBlur-->v.showTab-->"+component.get("v.showTab"));
        
        var currTabId = event.getSource().get('v.id');
        //console.log("In  SalesPLanningTurkeyComp-->-->C-->onTabBlur--> currTabId-->"+currTabId);
        if(component.find(currTabId)!=null || component.find(currTabId)!='undefined'){
            //console.log("In  SalesPLanningTurkeyComp-->-->C-->onTabBlur_M-->Inside Destroy!!!");
            component.find(currTabId).destroy();
            //console.log("In SalesPLanningTurkeyComp-->-->C-->onTabBlur_M-->COMP-->"+currTabId+" is Destroyed...");
        }else{
